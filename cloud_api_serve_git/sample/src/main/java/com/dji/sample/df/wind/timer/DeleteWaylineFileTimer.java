...
//
//    // 每天凌晨0点执行（可能不需要，现在只生成一次航线计划，可重复执行）
//    @Scheduled(cron = "0 0 0 * * ?")
//    public void deleteKmzFiles() {
//        String projectPath = System.getProperty("user.dir");
//        int lastSlashIndex = projectPath.lastIndexOf('\\');
//
//        String substring = projectPath.substring(0, lastSlashIndex);
//        String kmzFolderPath = substring + File.separator + "file"+ File.separator + "kmz";
//
