...
@Service
@Slf4j
public class MediaServiceImplDf extends AbstractMediaService implements IMediaServiceDf {
    ...
    @Override
    public TopicEventsResponse<MqttReply> fileUploadCallback(TopicEventsRequest<FileUploadCallback> request,
