...
public class FlightTaskServiceImpl extends AbstractWaylineService implements IFlightTaskService {
    ...
    @Override
    public HttpResultResponse publishFlightTask(CreateJobParam param, CustomClaim customClaim,PubWaylineJobPlanDfEntity pubWaylineJobPlanDfEntity) throws SQLException {
        fillImmediateTime(param);
        //设置空任务id进行上级查询20241204
        String job_id = "";
...
//          todo 此处类型对吗
    ...
    @Override
    public HttpResultResponse cancelFlightTask(String workspaceId, Collection<String> jobIds) {
        ...
        return HttpResultResponse.success().setMessage(String.valueOf(jobIds));
