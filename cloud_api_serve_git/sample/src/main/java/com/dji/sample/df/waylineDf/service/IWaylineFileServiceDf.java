package com.dji.sample.df.waylineDf.service;
 ...
 * @date 2021/12/22
 */
public interface IWaylineFileServiceDf {
    ...
    PaginationData<GetWaylineListResponse> getWaylinesByName(String workspaceId,String name, GetWaylineListRequest param);
}
