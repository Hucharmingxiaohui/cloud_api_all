package com.dji.sample.df.thirdKmzDf.utils;

import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Folder;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.GlobalWaypointHeadingParam.GlobalWaypointHeadingParam;
...
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.ActionActuatorFuncParam;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.CustomDirName.CustomDirName;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.Focus.Focus;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.GimbalRotate.GimbalRotate;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.Hover.Hover;
...
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.RecordPointCloud.RecordPointCloud;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.RotateYaw.RotateYaw;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.StartRecord.StartRecord;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.StopRecord.StopRecord;
...
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.ActionGroup.Action.ActionActuatorFuncParam.Zoom.Zoom;
...
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.Point.Point;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.WaypointHeadingParam.WaypointHeadingParam;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.Placemark.WaypointTurnParam.WaypointTurnParam;
import com.dji.sample.df.thirdKmzDf.entity.wayline.Folder.WaylineCoordinateSysParam.WaylineCoordinateSysParam;
import com.dji.sample.df.thirdKmzDf.entity.wayline.MissionConfig.DroneInfo.DroneInfo;
import com.dji.sample.df.thirdKmzDf.entity.wayline.MissionConfig.MissionConfig;
import com.dji.sample.df.thirdKmzDf.entity.wayline.MissionConfig.PayloadInfo.PayloadInfo;
                           ...
                           // System.out.println(placemark);
                            ...
                            for (Element placemarkElement:placemarkList){
                                ...
                                if("gimbalPitchAngle".equals(placemarkElement.getName())){//云台角度
                                    placemark.setGimbalPitchAngle(Double.parseDouble(placemarkElement.getText()));
                                }
