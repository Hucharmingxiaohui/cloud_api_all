...
public class EdgeNodeCommand implements Serializable {
    ...
    private EdgeNodeCommandItem items;
    ...
    public EdgeNodeCommandItem getItems() {
        return this.items;
    }

    public void setItems(EdgeNodeCommandItem items) {
        this.items = items;
    }
