...
public class RouteFileUtils {
    ...
    public static KmlMissionConfig buildKmlMissionConfig(KmlParams kmlParams) {
        ...
        kmlMissionConfig.setTakeOffSecurityHeight(String.valueOf(kmlParams.getTakeOffSecurityHeight()));
        kmlMissionConfig.setGlobalHeight(String.valueOf(kmlParams.getGlobalHeight()));
        kmlMissionConfig.setGlobalTransitionalSpeed(String.valueOf(kmlParams.getGlobalTransitionalSpeed()));
        kmlMissionConfig.setGlobalRTHHeight(String.valueOf(kmlParams.getGlobalRTHHeight()));
    ...
    public static KmlDroneInfo buildKmlDroneInfo(Integer droneType, Integer subDroneType) {
        ...
        if (Objects.equals(droneType, DroneEnumValueEnums.M30_M30T.getValue()) ||
                ...
                Objects.equals(droneType, DroneEnumValueEnums.M4D_M4TD.getValue()))//xtj
        {
    ...
    public static KmlFolder buildKmlFolder(String fileType, KmlParams kmlParams) {
        ...
        if (StringUtils.equals(fileType, FileTypeConstants.WPML)) {
            ...
            kmlFolder.setExecuteHeightMode(ExecuteHeightModeEnums.WGS84.getValue());
        ...
        // 航点类型模板航线配置
        System.out.println("TemplateType: " + kmlFolder.getTemplateType());
        if (StringUtils.equals(kmlFolder.getTemplateType(), TemplateTypeEnums.WAYPOINT.getValue())) {
            //System.out.println("buildKmlPlacemark_1");
            ...
            if (CollectionUtil.isNotEmpty(routePointList)) {
                //System.out.println("buildKmlPlacemark_2");
...
//    }
    ...
    private static List<KmlAction> getKmlActionList(List<PointActionReq> actionList, KmlParams kmlParams) {
        ...
        for (PointActionReq pointActionReq : actionList) {
            if (ObjectUtil.isNotNull(pointActionReq.getHoverTime())) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.HOVER.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getAircraftHeading())) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.ROTATE_YAW.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getTakePhotoType()) && ObjectUtil.equals(pointActionReq.getTakePhotoType(), 0)) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.TAKE_PHOTO.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getTakePhotoType()) && ObjectUtil.equals(pointActionReq.getTakePhotoType(), 2)) {
                // ✅ 添加 orientedShoot 判断逻辑 xtj
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.ORIENTED_SHOOT.getValue(), pointActionReq, kmlParams));
            } else if ((ObjectUtil.isNotNull(pointActionReq.getGimbalYawRotateAngle())) || (ObjectUtil.isNotNull(pointActionReq.getGimbalPitchRotateAngle()))) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.GIMBAL_ROTATE.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getZoom())) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.ZOOM.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getTakePhotoType()) && ObjectUtil.equals(pointActionReq.getTakePhotoType(), 1)) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.PANO_SHOT.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getStartRecord()) && pointActionReq.getStartRecord()) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.START_RECORD.getValue(), pointActionReq, kmlParams));
            } else if (ObjectUtil.isNotNull(pointActionReq.getStopRecord()) && pointActionReq.getStopRecord()) {
                kmlActionList.add(buildKmlAction(String.valueOf(pointActionReq.getActionIndex()),
                        ActionActuatorFuncEnums.STOP_RECORD.getValue(), pointActionReq, kmlParams));
            }
        }
        return kmlActionList;
    }
    ...
    public static KmlPlacemark buildKmlPlacemark(RoutePointInfo routePointInfo, KmlParams kmlParams, String fileType) {
        ...
        //System.out.println("buildKmlPlacemark");
...
//            kmlActionActuatorFuncParam.setAircraftPathMode(AircraftPathModeEnums.CLOCKWISE.getValue());
            if (ObjectUtil.isNotNull(pointActionReq.getAircraftPathMode())) {
                kmlActionActuatorFuncParam.setAircraftPathMode(pointActionReq.getAircraftPathMode());
            } else {
                // 默认顺时针
                kmlActionActuatorFuncParam.setAircraftPathMode(AircraftPathModeEnums.CLOCKWISE.getValue());
            }
        ...
        }  else if (StringUtils.equals(actionActuatorFunc, ActionActuatorFuncEnums.ORIENTED_SHOOT.getValue())) {
            kmlActionActuatorFuncParam.setPayloadPositionIndex(String.valueOf(kmlParams.getPayloadPosition()));
            kmlActionActuatorFuncParam.setPayloadLensIndex(pointActionReq.getImageFormat());
            kmlActionActuatorFuncParam.setUseGlobalPayloadLensIndex(String.valueOf(pointActionReq.getUseGlobalImageFormat()));
            kmlActionActuatorFuncParam.setGimbalYawRotateAngle(String.valueOf(pointActionReq.getGimbalYawRotateAngle()));
            ...
            // kmlActionActuatorFuncParam.setAFPos(String.valueOf(pointActionReq.getAFPos()));
            kmlActionActuatorFuncParam.setFocalLength(String.valueOf(pointActionReq.getFocalLength()));
            kmlActionActuatorFuncParam.setFocusX("480");
            kmlActionActuatorFuncParam.setFocusY("360");
//            kmlActionActuatorFuncParam.setFocusX(String.valueOf(pointActionReq.getFocusX()));
//            kmlActionActuatorFuncParam.setFocusY(String.valueOf(pointActionReq.getFocusY()));
            kmlActionActuatorFuncParam.setImageWidth(String.valueOf(pointActionReq.getImageWidth()));
            kmlActionActuatorFuncParam.setImageHeight(String.valueOf(pointActionReq.getImageHeight()));
            kmlActionActuatorFuncParam.setOrientedCameraApertue(String.valueOf(pointActionReq.getOrientedCameraApertue()));
            kmlActionActuatorFuncParam.setOrientedCameraLuminance(String.valueOf(pointActionReq.getOrientedCameraLuminance()));
            kmlActionActuatorFuncParam.setOrientedCameraShutterTime(String.valueOf(pointActionReq.getOrientedCameraShutterTime()));
            kmlActionActuatorFuncParam.setOrientedCameraISO(String.valueOf(pointActionReq.getOrientedCameraISO()));
