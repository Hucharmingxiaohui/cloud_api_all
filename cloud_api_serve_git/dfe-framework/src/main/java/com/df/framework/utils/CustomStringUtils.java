...
public class CustomStringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String replaceBlank(String str) {
        if (null != str) {
            ...
            return CustomStringUtils.trim(dest);
        } else {
            return "";
        }
    }
    ...
    public static String replaceAllBlank(String str) {
        if (str != null) {
            Matcher m = BLANK_ALL_PATTERN.matcher(str);
            String dest = m.replaceAll("");
            return CustomStringUtils.trim(dest);
        } else {
            return "";
    ...
    public static BigDecimal getStringNumPart(String input) {
        ...
        try {
            ...
            return new BigDecimal((isF ? "-" + digits : digits.toString()));
