...
public class HttpClientConfig {
     ...
     * 创建HTTP客户端工厂
     */
    @Bean(name = "cclientHttpRequestFactory")
    ...
    public RestTemplate restTemplate(@Qualifier("cclientHttpRequestFactory") ClientHttpRequestFactory factory) {
    ...
    public HttpClient httpClient() {
        ...
        try {
            ...
            // 重试次数
            httpClientBuilder.setRetryHandler(new DefaultHttpRequestRetryHandler(httpClientPoolConfig.getRetryTimes(),
                    true));
