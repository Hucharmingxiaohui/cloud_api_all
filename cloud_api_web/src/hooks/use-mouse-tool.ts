    ...
    root?.$mouseTool.marker({
      ...
      content: `
            <div style="position: relative; display: inline-block;">
                <div style="position: absolute; bottom: 100%; left: 50%; transform: translateX(-50%); font-size: 13px; color: #fff; background-color: #22884f; padding: 2px 5px; border-radius: 3px;">
                    ${'航点' + state.pinNum}
                </div>
