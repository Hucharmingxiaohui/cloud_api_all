...
const columns = [
  { title: '账户', dataIndex: 'username', width: 150, sorter: (a: Member, b: Member) => a.username.localeCompare(b.username), className: 'titleStyle' },
  { title: '用户类别', dataIndex: 'user_type', width: 150, className: 'titleStyle' },
  ...
  // { title: '修改', dataIndex: 'action', width: 100, className: 'titleStyle', slots: { customRender: 'action' } },
]
